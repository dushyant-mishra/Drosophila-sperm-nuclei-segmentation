...
print(f"\n--- NEW SESSION STARTED (v5.6-roi-adaptive): {os.path.basename(__file__)} ---")
...
CONFIG = {
    ...
    # ------ input / output ------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    "INPUT_DIR":    ".",
    "OUTPUT_DIR":   "./sperm_results_saturnv5_6",
...
class SpermGUI:
    ...
    def _launch_parameter_tuner(self, mode):
        ...
        tuner_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "utils", "tune_parameters_Saturnv5_6.py")
        ...
        try:
            ...
            if roi_mask is not None:
                roi_path = os.path.join(outdir, "last_drawn_roi_saturnv5_6_tune.tif")
    ...
    def run_analysis_slice(self):
        ...
        try:
            ...
            t0 = _t.time()
            log("  v5.6 ROI-adaptive single-pass analysis...")
