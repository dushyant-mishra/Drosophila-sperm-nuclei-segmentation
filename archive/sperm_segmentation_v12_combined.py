...
import os, sys, glob, re, warnings, heapq, argparse, math, pathlib as pl
...
# =============================================================================
# v12 ADVANCED AI BIOLOGICAL INTERPRETATION & HTML REPORTING
# =============================================================================
...
class SpermGUI:
    ...
    def __init__(self, root):
        ...
        # Bind only to canvas so it doesn't break main image view scrolling
