...
CONFIG = {
    ...
    # ── image enhancement ─────────────────────────────────────────────────────
    "CLAHE_CLIP":   0.141,   # Optimized for Saturn
    "CLAHE_KERNEL": 64,
    "BG_SIGMA":     21.0,    # Optimized for Saturn
    "RIDGE_SIGMAS": [1, 2, 3, 4],

    # ── hysteresis threshold ──────────────────────────────────────────────────
    "THRESHOLD_HI": 68.0,    # Optimized for Saturn
    "THRESHOLD_LO": 60.4,    # Optimized for Saturn
    ...
    "MIN_SKEL_LEN_PX":        6.6,  # Optimized for Saturn
    "MAX_GEODESIC_LEN_PX":    65.0, # backend actively cuts chains longer than this
    "MAX_WIDTH_PX":           32.5, # Optimized for Saturn
    "MIN_LENGTH_WIDTH_RATIO": 1.06, # Optimized for Saturn

    # ── NEW topology filters ──────────────────────────────────────────────────
    "MAX_BRANCH_NODES": 125,      # Optimized for Saturn
    "MAX_TORTUOSITY": 831.9,      # Optimized for Saturn
    "MAX_ENDPOINT_COUNT": 466,    # Optimized for Saturn
