"""Compact graphical launcher for Saturn v5.7 parameter tuning workflows."""
...
def build_single_stack_command(values, python_executable=None):
    """Build a validated command for the core v5.7 tuner."""
...
class TunerWorkspace:
    def __init__(self, root, defaults):
        self.root = root
        self.root.title("Saturn v5.7 Tuning Workspace")
