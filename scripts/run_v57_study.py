"""Run Saturn v5.7 Study Manager reproducibly from the command line."""
...
PIPELINE_PATH = ROOT / "sperm_segmentation_saturnv5.7.py"


def load_pipeline():
    spec = importlib.util.spec_from_file_location("saturn_v57_study", PIPELINE_PATH)
